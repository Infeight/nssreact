...
const Home = () => {
    ...
    const sneakpeaks = async()=>{
        const sneak = await fetch('http://localhost:5001/sneakpeaks',{headers:{accept:'application/json'}})
   ...
   const upeve = async()=>{
    const data = await fetch('http://localhost:5001/upevents',{headers:{accept:'application/json'}})
   ...
   const exps = async()=>{
    const exps = await fetch('http://localhost:5001/experience',{headers:{accept:'application/json'}})
